...
;(function(root, factory){
    ...
    const proxyC = new Proxy(C, {
        get: (target, prop) => prop in target ? target[prop] : C
    })
    ...
    const randomColor = () => `color:${getRandomProperty(colors)}`;
    const randomBg = () => `background:${getRandomProperty(colors)}; padding:0 5px`;
